...
INSERT INTO `tip` (`tip_id`, `user_id`, `tab_id`, `tip_title`, `tip_content`, `tip_publishTime`, `tip_modifyTime`, `tip_click`, `tip_isDeleted`, `tip_isKnot`, `tip_replies`) VALUES
	...
	(2, 2, 2, '官宣：本论坛正式开通', '欢迎发表高质量贴子\r\n#!/bin/bash\r\necho "Hello World !"', '2019-10-24 13:53:49', '2019-11-22 10:35:27', 80, 0, 0, 3),
	(3, 1, 1, '发贴时的版块与分类选项联动', '用ajax访问有@ResponseBody注解的Controller，然后对返回的tabList进行处理，刷新分类下拉栏的选项。', '2019-10-27 23:29:11', '2019-10-28 09:38:36', 32, 0, 0, 3),
	(4, 1, 1, '防止贴子内容中弹出用户输入的脚本', '需要对用户输入的内容进行处理。', '2019-10-29 17:52:15', '2019-10-29 18:03:31', 13, 0, 0, 2),
	(5, 3, 1, 'test tip51324123123', 'test23125123123124', '2019-11-22 11:23:17', '2019-12-18 10:45:11', 52, 0, 0, 6);
